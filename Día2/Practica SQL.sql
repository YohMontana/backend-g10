...
-- 4. CREAR UNA TABBLA LLAMADA ALMACEN en la cual seria de la sgte manera:
-- id entero llave primaria y auto incrementable
-- nombre text
-- direccion text
...
-- 2. Mostrar todos los productos cuya fecha de vecimiento sea menor al 1 de agosto del 2022
